...
st.markdown("<h1 class='main-heading'>Dermatology Prediction System</h1>", unsafe_allow_html=True)

st.markdown("<hr class='divider'>", unsafe_allow_html=True)

st.markdown(
    "<div class='welcome-message'>"
    "Welcome to the <strong>Dermatology Predictor</strong>, designed to help Doctors assess and predict potential dermatological conditions for all of your patients! "
